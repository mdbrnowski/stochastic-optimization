...
t.test(results[[1]]$PRS, results[[1]]$GA, alternative = "greater")$p.value
t.test(results[[2]]$PRS, results[[2]]$GA, alternative = "greater")$p.value
t.test(results[[3]]$PRS, results[[3]]$GA, alternative = "greater")$p.value
